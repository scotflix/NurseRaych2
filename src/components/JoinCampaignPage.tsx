...
export function JoinCampaignPage() {
  const [currentScreen, setCurrentScreen] = useState('confirmation');
  ...
  const [userInfo] = useState({ name: '', email: '', whatsapp: '' });
  const [showConfetti, setShowConfetti] = useState(false);
  const [, setIsJoiningCampaign] = useState(false);
              ...
              <div className="text-center">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                  <button 
                    ...
                    className="bg-blue-600 text-white py-3 rounded-xl font-semibold hover:bg-blue-700 transition-colors flex items-center justify-center"
                  >
                  ...
                  <button 
                    ...
                    className="bg-pink-500 text-white py-3 rounded-xl font-semibold hover:bg-pink-600 transition-colors flex items-center justify-center"
                  >
                  ...
                  <button 
                    ...
                    className="bg-green-500 text-white py-3 rounded-xl font-semibold hover:bg-green-600 transition-colors flex items-center justify-center"
                  >
                ...
                <button 
                  ...
                  className="bg-gradient-to-r from-purple-500 to-cyan-500 text-white px-8 py-4 rounded-full font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center mx-auto"
                >
